...
export class PanneauPoi extends HTMLElement {
  ...
  pictoMenu('recharge')}<span>Recharge et services</span></summary>
        ...
        <!-- LA RECHERCHE PAR CATÉGORIES A ÉTÉ RETIRÉE ICI (ERGO-5, 02/09).
             ELLE FAISAIT DOUBLON, et c'est ERGO-3 qui l'a rendu visible en
             rapprochant les deux surfaces : l'entonnoir porte les familles de
             POI — continues, qui suivent la carte et servent de légende — et
             ce volet portait les MÊMES libellés en version « un clic, un
             appel ». Deux listes identiques dans un même panneau ne se
             choisissent pas, elles se confondent.
             ARMELIN A TRANCHÉ le 02/09 : « on va garder les POI continus et
             supprimer le doublon dans le panneau de recharge. » Les familles
             de l'entonnoir font le même travail, et mieux : elles restent
             affichées, ce qui en fait une légende. -->
